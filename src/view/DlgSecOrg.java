...
public class DlgSecOrg extends JDialog implements IDlg {
	...
	public void setHead(String head) {
		textField_2.setText(head);
	}

	public static void main(String[] args) {
		try {
			dialog = new DlgSecOrg();
	...
	public DlgSecOrg() {
		...
		textField_2.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Head", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
